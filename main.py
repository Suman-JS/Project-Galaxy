...
class MainWidget(RelativeLayout):
    ...
    def init_audio(self):
        ...
        self.sound_galaxy = SoundLoader.load("galaxy.wav")
        self.sound_gameover_impact = SoundLoader.load("gameover_impact.wav")
        self.sound_gameover_voice = SoundLoader.load("gameover_voice.wav")
        self.sound_music1 = SoundLoader.load("music1.wav")
